package uk.co.anttheantster.antsempireutils.utils;
...
public class VersionChecker {
    ...
    private static final String VERSION_URL = "https://raw.githubusercontent.com/AntTheAntster/AntsEmpireUtils/refs/heads/master/version.json";
        ...
        if (!checked && Minecraft.getInstance().player != null) {
            ...
            new Thread(() -> {
                try {
                    ...
                    if (!latestVersion.equals(AntsEmpireUtils.version)){
    ...
    private static void displayMessage(Player player){
        player.displayClientMessage(
                Component.literal("§cAntsEmpireUtils is outdated! You're using " + AntsEmpireUtils.version + "! Please update to " + latestVersion + "!"),
                false);
        player.displayClientMessage(
